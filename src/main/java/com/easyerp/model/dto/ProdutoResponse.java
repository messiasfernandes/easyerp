...
public record ProdutoResponse(Long id, String produto, MarcaResponse marca, BigDecimal custo, BigDecimal custoMedio,
		BigDecimal precoVenda,
		Set<ProdutoVariacaoResponse> variacoes)
{
	public ProdutoResponse(Produto produto) {
		this(produto.getId(), produto.getProdutoNome(),
				produto.getMarca() != null ? new MarcaResponse(produto.getMarca()) : null, produto.getCusto(),
